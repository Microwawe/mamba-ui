export const ethicalads = (function (e) {
	var t = {};
	function a(o) {
			...
			(n = function () {
				...
				return (
					...
					(e.inViewport = function (e, t) {
						var a = c(e, t);
						return (
							!!a && a.bottom >= 0 && a.right >= 0 && a.top <= d() && a.left <= i()
						);
					}),
					e
				);
											...
											return new Promise(function (a, o) {
												window[t] = function (t) {
													if (t && t.html && t.view_url) {
														...
														return (
															(o.innerHTML = t.html), a(o.firstChild)
														);
													}
													return a(null);
												};
								...
								[
									{
										...
										value: function (t) {
											...
											return (
												('image' !== o && 'text' !== o) || (o += '-v1'),
												(t.className || '').split(' ').indexOf('loaded') >=
												0
							...
							v()
								...
								.catch(function (t) {
									if ((e([]), t instanceof Error)) {
										if (t instanceof j) return void console.debug(t.message);
	...
	function (e, t, a) {
		...
		function m(e, t) {
			...
			if (t.singleton) {
				var r = y++;
				(a = h || (h = c(t))), (o = p.bind(null, a, r, !1)), (n = p.bind(null, a, r, !0));
			} else
				(a = c(t)),
					(o = f.bind(null, a, t)),
					(n = function () {
			...
			return (
				...
				(t.i = function (e, a, o) {
					...
					for (var d = 0; d < e.length; d++) {
						var l = [].concat(e[d]);
						(o && n[l[0]]) ||
							(a && (l[2] ? (l[2] = ''.concat(a, ' and ').concat(l[2])) : (l[2] = a)),
							t.push(l));
					}
				}),
				t
